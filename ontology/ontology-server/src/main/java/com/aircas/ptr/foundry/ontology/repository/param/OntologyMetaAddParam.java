...
public class OntologyMetaAddParam {
    ...
    @ApiModelProperty(name = "isMapAllParam", value = "是否映射datasource的列为属性，在backingDatasourceId存在时生效", example = "true", required = false)
    private Boolean isMapAllParam;

    @ApiModelProperty(name = "titleKey", value = "标题列名，在backingDatasourceId存在时生效", example = "name", required = false)
    private String titleKey;

    @ApiModelProperty(name = "primaryKey", value = "主键列名，在backingDatasourceId存在时生效", example = "id", required = false)
