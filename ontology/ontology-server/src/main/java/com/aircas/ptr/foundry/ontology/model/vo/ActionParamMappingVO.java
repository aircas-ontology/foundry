...
@Schema(description = "行为参数映射VO")
public class ActionParamMappingVO {

    @Schema(description = "关联的函数参数值的spel表达式", required = true, example = "data[0].name")
    private String functionParamExpression;

    @Schema(description = "关联的函数参数id", required = true)
    private Long functionParamId;


    @Schema(description = "属性关联本体id", required = true, example = "abcd1234")
