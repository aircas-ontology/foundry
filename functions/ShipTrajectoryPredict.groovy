...
@Slf4j
class ShipTrajectoryPredict {

    FunctionResultVO<JsonNode> handle(List<Double> lat, List<Double> lon, List<Double> timestamp, Double seaWaveHeight, List<Double> seaAreaLat, List<Double> seaAreaLon) {
